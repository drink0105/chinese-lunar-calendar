export const lunarTerms: Record<string, Record<string, string>> = {
  ...
  "整手足甲": { en: "Trim Nails / Manicure & Pedicure", th: "ตัดเล็บ", vi: "Cắt móng tay tay chân", "zh-CN": "整手足甲", "zh-TW": "整手足甲" },
...
export const jieqiMap: Record<string, Record<string, string>> = {
  ...
  "白露": { en: "White Dew", th: "น้ำค้างขาว", vi: "Bạch Lộ", "zh-CN": "Bạch Lộ", "zh-TW": "白露" },
...
export const festivalsMap: Record<string, Record<string, string>> = {
  ...
  "财神节": { en: "God of Wealth Festival", th: "เทศกาลเจ้าแห่งโชคลาภ", vi: "Tết Thần Tài", "zh-CN": "财神节", "zh-TW": "財神節" },
  "教师节": { en: "Teachers' Day", th: "วันครู", vi: "Ngày Nhà giáo", "zh-CN": "教师节", "zh-TW": "教師節" },
  "地藏节": { en: "Ksitigarbha Festival", th: "เทศกาลพระธรณี", vi: "Tết Địa Tạng", "zh-CN": "地藏节", "zh-TW": "地藏節" },
  "天灸日": { en: "Tianjiu Day", th: "วันเทียนจิ่ว", vi: "Ngày Thiên Cứu", "zh-CN": "天灸日", "zh-TW": "天灸日" },
  ...
  "平安夜": { en: "Christmas Eve", th: "คืนก่อนคริสต์มาส", vi: "Đêm Giáng Sinh", "zh-CN": "平安夜", "zh-TW": "平安夜" },
  "圣诞节": { en: "Christmas", th: "คริสต์มาส", vi: "Giáng Sinh", "zh-CN": "圣诞节", "zh-TW": "聖誕節" },
  "元旦节": { en: "New Year's Day", th: "วันปีใหม่", vi: "Ngày Đầu Năm", "zh-CN": "元旦节", "zh-TW": "元旦節" },
