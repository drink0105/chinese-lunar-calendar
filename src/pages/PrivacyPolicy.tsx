    ...
    <div className="max-w-4xl mx-auto px-4 py-12 pb-32">
      ...
      <div className="max-w-[800px] mx-auto p-6 md:p-10 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 rounded-[2rem] shadow-xl border border-border/50">
        ...
        <div className="space-y-4 font-medium text-sm md:text-base leading-relaxed">
          ...
          <p><strong>Developer:</strong> App-2-U</p>
          <p><strong>Last Updated:</strong> January 2026</p>

          <h2 className="text-xl md:text-2xl font-black text-primary mt-8 mb-4">Introduction</h2>
          <p>LunarDays - Chinese Calendar ("App-2-U", "we", "our", or "the app") is committed to protecting your privacy. This Privacy Policy explains how App-2-U collects, uses, and protects information when you use our application.</p>

          <h2 className="text-xl md:text-2xl font-black text-primary mt-8 mb-4">Information We Collect</h2>
          <p>LunarDays - Chinese Calendar does not require registration, login, or any personal account creation. App-2-U does not directly collect or store any personally identifiable information.</p>
          ...
          <h2 className="text-xl md:text-2xl font-black text-primary mt-8 mb-4">How App-2-U Uses Information</h2>
          <p>Information collected through advertising partners is used solely to display relevant advertisements. App-2-U does not sell, trade, or transfer your information to third parties outside of our advertising partners.</p>

          <h2 className="text-xl md:text-2xl font-black text-primary mt-8 mb-4">Data Retention</h2>
          <p>App-2-U does not retain personal data on our servers. Advertising partner data retention is governed by their respective privacy policies.</p>

          <h2 className="text-xl md:text-2xl font-black text-primary mt-8 mb-4">Children's Privacy</h2>
          <p>This app is suitable for all ages. App-2-U does not knowingly collect personal information from children under 13.</p>
          ...
          <p>App-2-U may update this Privacy Policy from time to time. Continued use of the app after changes constitutes acceptance of the updated policy.</p>

          <h2 className="text-xl md:text-2xl font-black text-primary mt-8 mb-4">Contact</h2>
          <p>For privacy-related questions, contact App-2-U through the app's store listing page.</p>
        </div>
      </div>
    </div>
  );
